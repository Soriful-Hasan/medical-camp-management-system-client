    ...
    <div>
      <div className=" flex gap-4  items-center ">
        ...
        <button
          onClick={handleClick}
          type="button w-full"
          className="text-white bg-my-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2   dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          Apply Filter
        </button>
      </div>
