...
const Question = () => {
  ...
  return (
    <div className="">
      {question?.map((ques) => (
        <div className="mt-6 collapse collapse-arrow bg-base-100 border border-base-300">
          <input type="radio" name="my-accordion-2" defaultChecked />
          <div className="collapse-title font-semibold">{ques.question}</div>
          <div className="collapse-content text-sm bg-[E62]">
