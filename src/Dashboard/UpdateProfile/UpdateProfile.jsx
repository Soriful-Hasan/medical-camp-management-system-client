...
import useUpdateUserProfileDB from "./useUpdateUserProfileDB";
...
const UpdateProfile = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const dbRes = await axiosSecure.patch(`/updateProfile/${user?.email}`, {
        name,
  ...
  return (
    <div class="md:w-2xl w-full   md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-my-primary/6 dark:bg-dark-secondary dark:text-white shadow-sm rounded-lg text-gray-900">
