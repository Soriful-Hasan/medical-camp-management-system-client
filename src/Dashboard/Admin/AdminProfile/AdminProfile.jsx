...
const AdminProfile = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const dbRes = await axiosSecure.patch(
        `admin/updateProfile/${user?.email}`,
        {
          name,
  ...
  return (
    <div className="p-4">
      <div class="md:w-2xl  w-full  md:mx-auto lg:mx-auto xl:mx-auto md:mt-16 bg-white dark:bg-dark-primary  dark:text-white shadow-sm rounded-lg text-gray-900">
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                accept="image/*"
                className="block w-full mt-1 border border-gray-300 shadow-sm rounded-md bg-white text-sm 
